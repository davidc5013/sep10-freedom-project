...
*  Also while tinkering it was recently today i wanted to see if my old notes would still work, `hovering`, `background-color` so once i tried it actually worked so its good to know[Freecodecamp](https://www.freecodecamp.org/learn/responsive-web-design)
